...
func Ec2instances() *schema.Table {
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			{
				Name:     "capacity_reservation_target_capacity_reservation_id",
				Type:     schema.TypeString,
				Resolver: schema.PathResolver("CapacityReservationTarget.CapacityReservationId"),
			},
			{
				Name:     "capacity_reservation_target_capacity_reservation_resource_group_arn",
				Type:     schema.TypeString,
				Resolver: schema.PathResolver("CapacityReservationTarget.CapacityReservationResourceGroupArn"),
			},
			{
				Name: "client_token",
				Type: schema.TypeString,
